      ...
      <FlatList
        ...
        ListEmptyComponent={
          <AppCard
            ...
            bordered
          >
            <MaterialCommunityIcons name="shield-alert-outline" size={36} color={mutedColor} />
            <AppText
              align="center"
              variant="body"
              weight="medium"
          ...
          return (
            <AppCard style={{ marginBottom: 12 }}>
              ...
              <View className="gap-1 mb-3">
                ...
                {slot && (
                  <View className="flex-row items-center gap-1">
                    <Feather name="clock" size={14} color={mutedColor} />
                    <AppText variant="caption">
                ...
                <View className="flex-row items-center gap-1">
                  <Feather name="award" size={14} color={mutedColor} />
