...
export default function DoctorDetailScreen({ id }: IDoctorDetailScreenProps) {
      ...
      <View className="p-4">
        ...
        <View className="flex-row gap-2 mb-5">
          <AppCard
            ...
            bordered
          >
            <Feather name="award" size={20} color={primaryColor} />
            <AppText
              weight="bold"
              style={{ fontSize: 13, marginVertical: 4, textAlign: "center" }}
            >
              {qualification}
            </AppText>
        ...
        <View className="mb-5">
          ...
          {availableServices.length === 0 ? (
            ...
            >
              <AppText align="center" variant="bodySecondary">
                This consultant currently has no active clinical slots or
                bookings open.
              </AppText>
            </AppCard>
          ) : (
                ...
                return (
                  <AppCard style={{ marginBottom: 12 }}>
                    ...
                    <View className="flex-row items-center mb-4">
                      ...
                      <Feather name="calendar" size={16} color={mutedColor} className="ml-4" />
                      <AppText variant="caption" className="ml-1">
                        Date:{" "}
                        {item.slotDate
